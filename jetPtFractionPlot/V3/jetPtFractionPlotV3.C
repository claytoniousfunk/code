...
// V3: introducing dN/dp_T by renormalizing by bin number
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Define the Canvas
      ...
      c1->SaveAs("jetPtFractionPlotV3-1.pdf");
*/
...
/*
    ...
    // Define the Canvas
      ...
      //fraction_stack->GetXaxis()->SetLabelFont(43); // Absolute font size in pixel (precision 3)
      //fraction_stack->GetXaxis()->SetLabelSize(12);
      c2->SaveAs("jetPtFractionPlotV3-2.pdf");
...
/*
    ...
    // Define the Canvas
      ...
      TH1D *h2 = (TH1D*)h_jetpt_lq->Clone("h2"); // light quarks
      ...
      //fraction_stack->GetXaxis()->SetLabelFont(43); // Absolute font size in pixel (precision 3)
      //fraction_stack->GetXaxis()->SetLabelSize(12);
      c3->SaveAs("jetPtFractionPlotV3-3.pdf");
...
/*
    ...
    // Define the Canvas
      ...
      c4->SaveAs("jetPtFractionPlotV3-4.pdf");
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    // Define the Canvas
      ...
      c5->SaveAs("jetPtFractionPlotV3-5.pdf");
