...
void normalizeAndCompareSpectraPt(){
	...
	TFile *f_pythia = TFile::Open("/home/clayton/Analysis/data/ppskim/pythia_skim_newWeights_pthatcut_30_muptcut_10.root");

	
	
  // pt
  
	f_pythia->GetObject("h_jetpt",pythia_pt);
	f_data->GetObject("h_jetpt",data_pt);
    
    TF1 *func = new TF1("func",func_temp,50.0,500.0,4);
...
// normalize pythia_pt_xnorm_rebin by bin width
    ...
    for (int l=0;l<Nbin4;l++){
      ...
      pythia_pt_xnorm_rebin_xnorm->GetYaxis()->SetTitleSize(0.04);
...
///////////////////////////////////////////////////////////////////////////  ratio plot  ////////////////////////////////////////////////////////////////////////////
    ...
    r_raw->Fit("func","N","",50.0,500.0);
    //r->SetMinimum(0.8);
    //r->SetMaximum(1.2);
    //gStyle->SetOptFit(1);
    //r->Fit("pol7");
    //r->Fit("expo");
    c2->SaveAs("/home/clayton/Analysis/code/normalizeAndCompareSpectra/figures/pythiaDataPtCompare.pdf");
   ...
   data_pt_xnorm->GetYaxis()->SetTitleSize(0.04);
   ...
   data_pt_xnorm_xnorm->Draw("ep");
   pythia_pt_xnorm_fitscaled_xnorm->Draw("ep same");
   ...
   r2->SetMinimum(0.8);
   r2->SetMaximum(1.2);
   r2->GetXaxis()->SetTitle("jet p_{T} [GeV/c]");
   r2->GetYaxis()->SetTitle("Pythia / data");
   r2->GetXaxis()->SetTitleSize(0.09);
   r2->GetYaxis()->SetTitleSize(0.08);
   c3->SaveAs("/home/clayton/Analysis/code/normalizeAndCompareSpectra/figures/pythiaDataPtRescaleCompare.pdf");
