...
void normalizeAndCompareSpectraPtJussiVClaytonUnweighted(){
  ...
  // pt
	...
	f_clayton->GetObject("h_jetpt_raw",clayton_pt);
...
///////////////////////////////////////////////////////////////////////////  ratio plot  ////////////////////////////////////////////////////////////////////////////
    ...
    c2->SaveAs("/home/clayton/Analysis/code/normalizeAndCompareSpectra/figures/pythiaDataPtCompareJussiVClaytonUnweighted.pdf");
