	...
	//for(int evi = 1; evi < 5; evi++){	
		...
		for(int jetj = 0; jetj < em->njet; jetj++){
			...
			if(em->matchedHadronFlavor[jetj]==4){
				...
				if(em->matchedPartonFlavor[jetj]==1 || em->matchedPartonFlavor[jetj]==-1 || em->matchedPartonFlavor[jetj]==2 || em->matchedPartonFlavor[jetj]==-2 || em->matchedPartonFlavor[jetj]==3 || em->matchedPartonFlavor[jetj]==-3){
...
auto wf = TFile::Open("/uscms/home/cmbennet/work/PbPb_mc_skim_CsJets_noWeights_pthat30_muptcut10_4Sep20.root","recreate");
