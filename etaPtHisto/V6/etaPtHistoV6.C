...
void etaPtHistoV6(Double_t muPtCut = 2.5){
	...
	// DEFINE 2D HISTOGRAMS 
		...
		TH1D *h_muRelPt = new TH1D("h_muRelPt","p_{T}^{#mu}",50,0,5);
...
//auto wf = TFile::Open("etaPtHistoV6_muptcut_2-5.root","recreate");
//auto wf = TFile::Open("etaPtHistoV6_muptcut_5.root","recreate");
//auto wf = TFile::Open("etaPtHistoV6_muptcut_10.root","recreate");
//auto wf = TFile::Open("etaPtHistoV6_muptcut_15.root","recreate");
h2->Write();
h2_d->Write();
h2_u->Write();
h2_s->Write();
