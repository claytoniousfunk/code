...
void ccbarEtaRatioPlot(){
    ...
    TH1D *h1 = (TH1D*)h_jeteta_c->Clone("h1"); // c quarks
    TH1D *h2 = (TH1D*)h_jeteta_cbar->Clone("h2"); // c antiquarks
   ...
   c->SaveAs("ccbarEtaRatioPlot.pdf");
}