...
void udPtRatioPlot(){
    ...
    legend->AddEntry(h1,"u","fp");
    legend->AddEntry(h2,"d","fp");
    legend->Draw();
    ...
    h3->SetMinimum(1.4);  // Define Y ..
    h3->SetMaximum(2.6); // .. range
    ...
    // h1 settings
    h1->SetFillColorAlpha(kGreen-3,0.5);
    h1->SetMarkerStyle(8);
   ...
   // h2 settings
   h2->SetFillColorAlpha(kBlue-9,0.5);
   h2->SetLineWidth(1);
