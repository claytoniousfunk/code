...
void muonSkimV1(bool doCrab=0, int jobID=0, int endfile = 3203, int dataset_type_code = 2, int output_file_num = 1)
{
	bool is_pp = false;
	...
	/*while(instr>>filename && ifile<endfile){
		...
		TFile *my_file = TFile::Open("~/Analysis/skims4/HydJet_1.root");
