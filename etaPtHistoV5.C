...
void etaPtHistoV5(Double_t muPtCut = 2.5){
...
/*
if(muPtCut==2.5){
	auto wf = TFile::Open("etaPtHistoV5_muptcut_2-5.root", "recreate");
}
else if(muPtCut==5.0){
	auto wf = TFile::Open("etaPtHistoV5_muptcut_5.root", "recreate");
}
else if(muPtCut==10.0){
	auto wf = TFile::Open("etaPtHistoV5_muptcut_10.root", "recreate");
}
else if(muPtCut==15.0){
	auto wf = TFile::Open("etaPtHistoV5_muptcut_15.root", "recreate");
}
else{
	auto wf = TFile::Open("etaPtHistoV5.root", "recreate");
}
*/
auto wf = TFile::Open("etaPtHistoV5.root", "recreate");
//auto wf = TFile::Open("etaPtHistoV5_muptcut_2-5.root", "recreate");
