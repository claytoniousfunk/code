...
void bbbarEtaRatioPlot(){
    ...
    TH1D *h1 = (TH1D*)h_jeteta_b->Clone("h1"); // u quarks
    TH1D *h2 = (TH1D*)h_jeteta_bbar->Clone("h2"); // d quarks
   ...
   c->SaveAs("bbbarEtaRatioPlot.pdf");
}